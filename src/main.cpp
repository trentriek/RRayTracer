...
int main(int args, char** argv) {
	...
	Plane backplane = Plane(vector3(0.0f, 0.0f, 15.0f), vector3(0.0f, 0.0f, -1.0f));
	backplane.DebugColor = vector3(100.0f, 100.0f, 100.0f);
	Plane leftplane = Plane(vector3(-3.0f, 0.0f, 10.0f), vector3(1.0f, 0.0f, 0.0f));
	leftplane.DebugColor = vector3(10.0f, 10.0f, 10.0f);
	//Plane rightplane = Plane(vector3(1.0f, 0.0f, 0.0f), vector3(-1.0f, 0.0f, 0.0f));
	//leftplane.DebugColor = vector3(200.0f, 200.0f, 200.0f);
	...
	Light lightOne = Light(vector3(3.0f, 3.0f, -4.0f));
