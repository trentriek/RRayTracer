...
int main(int args, char** argv) {
	...
	Material mat4 = Material(vector3(130.0f, 150.0f, 10.0f), vector3(10.0f, 10.0f, 10.0f));
	...
	SpotLight Show = SpotLight(vector3(-2.0f, -4.0f, -5.0f), vector3(0, 0, 200), 1.0f);
	Show.Ni = vector3(-1.0, 0.0, 0.0);
	Show.coneangle = 3.14f;

	AreaLight a = AreaLight(vector3(10.0f, -1.0f, -3.0f), vector3(150, 150, 30), 1.0f);
	a.focus_dist = 100.0;
	a.setlook(vector3(10.0f, -1.0f, -3.0f), vector3(9.0f, -1.0f, -3.0f));
	a.width = 6;
	a.height = 4;
